<?php
	...
	if (isset($_SESSION['password'])) {
		...
		if (isset($_POST['submit'])) {
			...
			if (empty($eventid)) {
				echo '<br />Please Enter an Event ID <br />';
			} else {
				...
				if ($dbEventID == $eventid) {
					$_SESSION['eventid3'] = $eventid;
					header('Location: StudentEventMajor2.php');					
				} else {
					echo '<br />That Event ID Does Not Exist.<br />';
				}
			}
		}
	}
...
<html>
    ...
    <body>
		...
		<br>
		<br>
	    <form method="post" action="StudentEventMajor.php">
